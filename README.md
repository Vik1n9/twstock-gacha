...
| 檔次 | 判定 | 解析度上限 | 粒子 | bloom／噪點 | 演出中／結果頁張數 |
|---|---|---:|---:|---|---:|
| `low` | 觸控且核心 ≤ 4 或記憶體 ≤ 3 GB | 1.0x | 40% | 皆關 | 30／20 |
| `mid` | 其餘觸控裝置、或核心 ≤ 4 的桌機 | 1.5x | 65% | 只開 bloom | 45／24 |
| `high` | 桌機且核心 > 4、記憶體 > 4 GB | 2.0x | 100% | 皆開 | 60／30 |
